		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="上班打卡时间" prop="shangbandakashijian">
							<el-date-picker
								class="list_date"
								v-model="form.shangbandakashijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.shangbandakashijian?true:false"
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.shangbandakashijian = context?.$toolUtil.getCurDateTime()
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='shangbandakashijian'){
					form.value.shangbandakashijian = row[x];
					disabledForm.value.shangbandakashijian = true;
					continue;
				}
				if(x=='kaoqinriqi'){
