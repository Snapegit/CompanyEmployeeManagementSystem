		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="外出开始时间" prop="waichukaishishijian">
							<el-date-picker
								class="list_date"
								v-model="form.waichukaishishijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.waichukaishishijian?true:false"
								placeholder="请选择外出开始时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="外出结束时间" prop="waichujieshushijian">
							<el-date-picker
								class="list_date"
								v-model="form.waichujieshushijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.waichujieshushijian?true:false"
								placeholder="请选择外出结束时间" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="外出发起日期" prop="waichufaqiriqi">
							<el-date-picker
								class="list_date"
								v-model="form.waichufaqiriqi"
								format="YYYY 年 MM 月 DD 日"
								value-format="YYYY-MM-DD"
								type="datetime"
								:readonly="!isAdd||disabledForm.waichufaqiriqi?true:false"
								placeholder="请选择外出发起日期" />
						</el-form-item>
					</el-col>
				</el-row>
			</el-form>
...
<script setup>
	...
	const disabledForm = ref({
		...
		waichukaishishijian : false,
		waichujieshushijian : false,
		waichufaqiriqi : false,
		shhf : false,
		sfsh : false,
	})
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.waichufaqiriqi = context?.$toolUtil.getCurDate()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='waichukaishishijian'){
					form.value.waichukaishishijian = row[x];
					disabledForm.value.waichukaishishijian = true;
					continue;
				}
				if(x=='waichujieshushijian'){
					form.value.waichujieshushijian = row[x];
					disabledForm.value.waichujieshushijian = true;
					continue;
				}
				if(x=='waichufaqiriqi'){
					form.value.waichufaqiriqi = row[x];
					disabledForm.value.waichufaqiriqi = true;
					continue;
				}
			}
			if(row){
