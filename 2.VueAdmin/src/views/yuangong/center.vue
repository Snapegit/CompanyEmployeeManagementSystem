				...
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="学历" prop="xueli">
							<el-input class="list_inp" v-model="user.xueli"  placeholder="学历" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="工作经历" prop="gongzuojingli">
							<el-input class="list_inp" v-model="user.gongzuojingli"  placeholder="工作经历" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
					...
					<el-col :span="12">
						<el-form-item label="岗位" prop="gangwei">
							<el-input class="list_inp" v-model="user.gangwei"  placeholder="岗位" clearable />
						</el-form-item>
					</el-col>
					<el-col :span="12">
