	...
	<div>
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					<el-col :span="12">
						<el-form-item label="考勤日期" prop="kaoqinriqi">
							<el-date-picker
								class="list_date"
								v-model="form.kaoqinriqi"
								format="YYYY 年 MM 月 DD 日"
								value-format="YYYY-MM-DD"
								type="datetime"
								:readonly="!isAdd||disabledForm.kaoqinriqi?true:false"
								placeholder="请选择考勤日期" />
						</el-form-item>
					</el-col>
					<el-col :span="12">
						<el-form-item label="下班打卡时间" prop="xiabandakashijian">
							<el-date-picker
								class="list_date"
								v-model="form.xiabandakashijian"
								format="YYYY-MM-DD HH:mm:ss"
								value-format="YYYY-MM-DD HH:mm:ss"
								type="datetime"
								:readonly="!isAdd||disabledForm.xiabandakashijian?true:false"
...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		resetForm()
			form.value.kaoqinriqi = context?.$toolUtil.getCurDate()
			form.value.xiabandakashijian = context?.$toolUtil.getCurDateTime()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				if(x=='kaoqinriqi'){
					form.value.kaoqinriqi = row[x];
					disabledForm.value.kaoqinriqi = true;
					continue;
				}
				if(x=='xiabandakashijian'){
					form.value.xiabandakashijian = row[x];
					disabledForm.value.xiabandakashijian = true;
					continue;
				}
				if(x=='bumenmingcheng'){
