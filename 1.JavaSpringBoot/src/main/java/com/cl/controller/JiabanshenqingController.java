...
public class JiabanshenqingController {
    ...
    public R page(@RequestParam Map<String, Object> params,JiabanshenqingEntity jiabanshenqing,
		...
		if(tableName.equals("yuangong")) {
			jiabanshenqing.setZhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R info(@PathVariable("id") Long id){
		...
		jiabanshenqing = jiabanshenqingService.selectView(new EntityWrapper<JiabanshenqingEntity>().eq("id", id));
    ...
    public R update(@RequestBody Long[] ids, @RequestParam String sfsh, @RequestParam String shhf){
        List<JiabanshenqingEntity> list = new ArrayList<JiabanshenqingEntity>();
        for(Long id : ids) {
            JiabanshenqingEntity jiabanshenqing = jiabanshenqingService.selectById(id);
            jiabanshenqing.setSfsh(sfsh);
            jiabanshenqing.setShhf(shhf);
            list.add(jiabanshenqing);
        }
        jiabanshenqingService.updateBatchById(list);
        return R.ok();
    }
    ...
    public R value(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiabanshenqingService.selectValue(params, ew);
    ...
    public R valueDay(@PathVariable("yColumnName") String yColumnName, @PathVariable("xColumnName") String xColumnName, @PathVariable("timeStatType") String timeStatType,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiabanshenqingService.selectTimeStatValue(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R group(@PathVariable("columnName") String columnName,HttpServletRequest request) {
        ...
        List<Map<String, Object>> result = jiabanshenqingService.selectGroup(params, ew);
        SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd");
        for(Map<String, Object> m : result) {
            for(String k : m.keySet()) {
                if(m.get(k) instanceof Date) {
    ...
    public R count(@RequestParam Map<String, Object> params,JiabanshenqingEntity jiabanshenqing, HttpServletRequest request){
        String tableName = request.getSession().getAttribute("tableName").toString();
        if(tableName.equals("yuangong")) {
            jiabanshenqing.setZhanghao((String)request.getSession().getAttribute("username"));
        }
        EntityWrapper<JiabanshenqingEntity> ew = new EntityWrapper<JiabanshenqingEntity>();
        int count = jiabanshenqingService.selectCount(MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, jiabanshenqing), params), params));
