...
public interface QingjiashenqingService extends IService<QingjiashenqingEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<QingjiashenqingEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<QingjiashenqingEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<QingjiashenqingEntity> wrapper);
