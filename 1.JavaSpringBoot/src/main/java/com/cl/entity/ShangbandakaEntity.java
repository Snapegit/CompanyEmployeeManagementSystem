...
public class ShangbandakaEntity<T> implements Serializable {
	...
	@DateTimeFormat 		
	private Date shangbandakashijian;
	 ...
	 * 设置：上班打卡时间
	 */
	public void setShangbandakashijian(Date shangbandakashijian) {
		this.shangbandakashijian = shangbandakashijian;
	}
	/**
	 * 获取：上班打卡时间
	 */
	public Date getShangbandakashijian() {
		return shangbandakashijian;
	}
	/**
	 * 设置：考勤日期
	 */
