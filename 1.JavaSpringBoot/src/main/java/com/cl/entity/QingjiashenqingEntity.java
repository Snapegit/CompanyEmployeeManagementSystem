...
public class QingjiashenqingEntity<T> implements Serializable {
	...
	@DateTimeFormat 		
	private Date qingjiafaqishijian;
	 ...
	 * 设置：请假发起时间
	 */
	public void setQingjiafaqishijian(Date qingjiafaqishijian) {
		this.qingjiafaqishijian = qingjiafaqishijian;
	}
	/**
	 * 获取：请假发起时间
	 */
	public Date getQingjiafaqishijian() {
		return qingjiafaqishijian;
	}
	/**
	 * 设置：回复内容
	 */
