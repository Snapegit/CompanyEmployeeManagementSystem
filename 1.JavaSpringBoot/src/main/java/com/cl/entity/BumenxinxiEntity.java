...
public class BumenxinxiEntity<T> implements Serializable {
	 ...
	 * 设置：所属公司
	 */
	public void setSuoshugongsi(String suoshugongsi) {
	 ...
	 * 设置：部门成员
	 */
	public void setBumenchengyuan(String bumenchengyuan) {
		this.bumenchengyuan = bumenchengyuan;
	}
	/**
	 * 获取：部门成员
	 */
	public String getBumenchengyuan() {
		return bumenchengyuan;
	}
	/**
	 * 设置：部门图片
	 */
