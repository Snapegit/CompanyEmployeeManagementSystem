<template>
	<div class="app-contain" :style='{"width":"64%","padding":"20px 0 0","margin":"0 auto 30px","position":"relative","borderRadius":"20px","background":"#fff"}'>
			...
			<div class="usersBox" v-if="tabIndex=='center'">
				<el-form class="usersForm" ref="userFormRef" :model="userForm" label-width="120px" :rules="rules">
					<el-row>
						...
						<el-col :span="8">
							<el-form-item prop="xueli" label="学历">
								<el-input class="list_inp" v-model="userForm.xueli" placeholder="学历" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="8">
						...
						<el-col :span="8">
							<el-form-item prop="gangwei" label="岗位">
								<el-input class="list_inp" v-model="userForm.gangwei" placeholder="岗位" ></el-input>
							</el-form-item>
						</el-col>
						<el-col :span="12">
