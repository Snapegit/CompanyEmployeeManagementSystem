			...
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="学历" prop="xueli">
						<el-input class="list_inp" v-model="form.xueli" placeholder="学历"
							 type="text" 							:readonly="!isAdd||disabledForm.xueli?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="工作经历" prop="gongzuojingli">
						<el-input class="list_inp" v-model="form.gongzuojingli" placeholder="工作经历"
							 type="text" 							:readonly="!isAdd||disabledForm.gongzuojingli?true:false" />
					</el-form-item>
				</el-col>
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='xueli'){
					form.value.xueli = row[x];
					disabledForm.value.xueli = true;
					continue;
				}
				if(x=='gongzuojingli'){
					form.value.gongzuojingli = row[x];
					disabledForm.value.gongzuojingli = true;
					continue;
				}
				if(x=='bumen'){
