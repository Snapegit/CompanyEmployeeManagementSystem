		...
		<div class="news_list_four">
			<div class="news_left">
				<template v-for="(item,index) in list" :key="index">
					<div class="four_left_item animation_box" v-if="index>=Number(2)" @click.stop="newsDetail(item.id)">
						<div class="time_box">
			...
			<div class="news_right">
				<template v-for="(item,index) in list" :key="index">
					<div class="four_right_item animation_box" v-if="index<Number(2)" @click.stop="newsDetail(item.id)">
						<div class="img_box">
