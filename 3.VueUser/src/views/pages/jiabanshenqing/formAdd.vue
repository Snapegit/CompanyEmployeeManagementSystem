	...
	<div class="app-contain" :style='{"minHeight":"100vh","padding":"0","margin":"20px auto 60px","borderRadius":"20px","background":"#fff","width":"64%","position":"relative","height":"100%"}'>
		...
		<el-form ref="formRef" :model="form" class="add_form" label-width="120px" :rules="rules">
			<el-row>
				...
				<el-col :span="8">
					<el-form-item label="加班开始时间" prop="jiabankaishishijian">
						<el-date-picker
							class="list_date"
							v-model="form.jiabankaishishijian"
							format="YYYY-MM-DD HH:mm:ss"
							value-format="YYYY-MM-DD HH:mm:ss"
							type="datetime"
							style="width:100%;"
							:readonly="!isAdd||disabledForm.jiabankaishishijian?true:false"
							placeholder="请选择加班开始时间" />
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="加班结束时间" prop="jiabanjieshushijian">
						<el-date-picker
							class="list_date"
							v-model="form.jiabanjieshushijian"
							format="YYYY-MM-DD HH:mm:ss"
							value-format="YYYY-MM-DD HH:mm:ss"
							type="datetime"
							style="width:100%;"
							:readonly="!isAdd||disabledForm.jiabanjieshushijian?true:false"
							placeholder="请选择加班结束时间" />
					</el-form-item>
				</el-col>
				<el-col :span="8">
					<el-form-item label="加班原因" prop="jiabanyuanyin">
						<el-input class="list_inp" v-model="form.jiabanyuanyin" placeholder="加班原因"
							 type="text" 							:readonly="!isAdd||disabledForm.jiabanyuanyin?true:false" />
					</el-form-item>
				</el-col>

				<el-col :span="8">
					<el-form-item label="加班发起日期" prop="jiabanfaqiriqi">
						<el-date-picker
							class="list_date"
							v-model="form.jiabanfaqiriqi"
							format="YYYY 年 MM 月 DD 日"
							value-format="YYYY-MM-DD"
							type="datetime"
							:readonly="!isAdd||disabledForm.jiabanfaqiriqi?true:false"
							placeholder="请选择加班发起日期"
							style="width: 100%;" />
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	//基础信息
	const tableName = 'jiabanshenqing'
	const formName = '加班申请'
	//基础信息
	const breadList = ref([{
		name: formName
	...
	const disabledForm = ref({
		...
		jiabankaishishijian : false,
		jiabanjieshushijian : false,
		jiabanyuanyin : false,
		jiabanfaqiriqi : false,
		shhf : false,
		sfsh : false,
	})
	...
	const init = (formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null) => {
			form.value.jiabanfaqiriqi = context?.$toolUtil.getCurDate()
		if(formId){
			id.value = formId
			type.value = formType
		}
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='jiabankaishishijian'){
					form.value.jiabankaishishijian = row[x];
					disabledForm.value.jiabankaishishijian = true;
					continue;
				}
				if(x=='jiabanjieshushijian'){
					form.value.jiabanjieshushijian = row[x];
					disabledForm.value.jiabanjieshushijian = true;
					continue;
				}
				if(x=='jiabanyuanyin'){
					form.value.jiabanyuanyin = row[x];
					disabledForm.value.jiabanyuanyin = true;
					continue;
				}
				if(x=='jiabanfaqiriqi'){
					form.value.jiabanfaqiriqi = row[x];
					disabledForm.value.jiabanfaqiriqi = true;
					continue;
				}
			}
			if(row){
